...
| `prisma-next-usage`            |        101 |          0 | +8 Phase 6.8 Playwright specs (cascade delete, scalar FK validation); demo contract gains `onDelete: "cascade"` on `User.posts` |
