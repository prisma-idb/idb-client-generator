...
| 8.6.1 | Chain regeneration + rename to `prisma.config.ts` (with the envelope) for the 3 deferred packages: `apps/prisma-next-usage`, kanban's IDB side, `sync-extension-idb`. Each has a _committed_ migration chain whose `end-contract.json` would go hash-inconsistent on re-emission (Phase 8.5's finding) — needs the shell Phase 8.6 built. Split out from 8.6 per the user's decision (migration-content risk, kept separate from CLI plumbing)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 8.6                                                                |
