...
export function addBigIntUpdateHandler(writer: CodeBlockWriter, models: readonly Model[]) {
  ...
  writer.writeLine(`export function handleBigIntUpdateField<T, R extends Prisma.Result<T, object, "findFirstOrThrow">>(record: R, fieldName: keyof R, bigIntUpdate: ${updateOperationType}): void`).block(() => {
    writer
