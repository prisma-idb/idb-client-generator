				...
				case 'Session': {
					{
						...
						result = await syncSession(event, validation.data, resolvedScopeKey, prisma);
						break;
					}
				}
				case 'Account': {
					{
						...
						result = await syncAccount(event, validation.data, resolvedScopeKey, prisma);
						break;
					}
				}
				case 'Verification': {
					{
						...
						result = await syncVerification(event, validation.data, resolvedScopeKey, prisma);
						break;
					}
				}
				default:
