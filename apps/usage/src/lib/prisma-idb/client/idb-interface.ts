...
export interface PrismaIDBSchema extends DBSchema {
  ...
  Post: {
    ...
    value: Prisma.Post;
    indexes: {
      authorIdIndex: [authorId: Prisma.Post["authorId"]];
    };
  };
  Comment: {
  ...
  ModelWithOptionalRelationToUniqueAttributes: {
    ...
    indexes: {
      linkIdIndex: [linkId: Prisma.ModelWithOptionalRelationToUniqueAttributes["linkId"]];
    };
  };
  ...
  Father: {
    ...
    indexes: {
      ...
      userIdIndex: [userId: Prisma.Father["userId"]];
    };
  };
  Mother: {
    ...
    value: Prisma.Mother;
    indexes: {
      userIdIndex: [userId: Prisma.Mother["userId"]];
    };
  };
  Child: {
    ...
    value: Prisma.Child;
    indexes: {
      userIdIndex: [userId: Prisma.Child["userId"]];
