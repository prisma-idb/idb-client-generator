...
See the [Indexes](/docs/indexes#idb-key-type-restrictions) page for full details on supported types, what happens with unsupported types, and how `@@index` fields are handled differently.
