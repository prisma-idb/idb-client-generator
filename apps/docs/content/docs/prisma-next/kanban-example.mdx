...
description: A Svelte app using Prisma Next IDB, migrations, auth, and full bidirectional sync
icon: LayoutDashboard
---

The Prisma Next kanban example is a full-stack SvelteKit app: an IndexedDB client in the browser, a Postgres server, [better-auth](https://better-auth.com) for sessions (Google OAuth and anonymous guest sign-in), and the [sync engine](/docs/prisma-next/sync) keeping the two databases in sync per user.
