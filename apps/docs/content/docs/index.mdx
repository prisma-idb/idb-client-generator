...
**Note**: This project is actively maintained and evolving. See the [GitHub repository](https://github.com/prisma-idb/idb-client-generator) for the latest features and roadmap.
